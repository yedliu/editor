...
import sortRectBoxComplex from '@/modelClasses/courseDetail/editItemViewModels/complexControl/sortRectBoxControl/sortRectBoxComplex';
import sortRectBoxUnitComplex from '@/modelClasses/courseDetail/editItemViewModels/complexControl/sortRectBoxControl/sortRectBoxUnitComplex';
...
const Template = props => {
  ...
  let data = dataContext as sortRectBoxComplex;
        ...
        return (
          ...
          >
            {rowUnits.map((unit, i) => {
              ...
              let keyboardunit = unit as sortRectBoxUnitComplex;
...
const DivCellOnClick = (event, dataContext) => {
  let data = dataContext as sortRectBoxUnitComplex;
...
class SelectedUnitsPropView extends PureComponent<any> {
  render() {
    ...
    SelectedItems = selectedUnits as sortRectBoxUnitComplex[];
...
export const PropPanelTemplate = SelectedItem => {
  return (
    <div>
      ...
      />
      {/* <div className={styles.propdiv}>排序盒子</div> */}

      <label style={{ float: 'left' }}>排序盒子</label>
      <Tooltip
      ...
      >
        {HelpBlueIcon(
          'https://hdkj-test.zmtalent.com/zmg_editor/zmg-pro-docs/docs/%E6%8E%A7%E4%BB%B6/%E6%8E%92%E5%BA%8F%E7%9B%92%E5%AD%90.html',
        )}
      </Tooltip>
