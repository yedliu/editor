...
export class TextToolbar extends React.Component<any, any> {
      ...
      <div>
        <div>
          <Select
            style={{ width: 100 }}
            size={'small'}
            value={textprop.FamilyFont || ''}
            onChange={value =>
              this.setValue('FamilyFont', value, ClassType.string)
            }
          >
        ...
        <div style={{ marginTop: 5, display: 'flex' }}>
          ...
          <ToggleButton
            ...
            isSelected={textprop.IsItalic}
            selectedChanged={value =>
              this.setValue('IsItalic', value, ClassType.bool)
            }
          />
          <ToggleButton
            background={'#1D91FC'}
            ...
            isSelected={textprop.IsUnderLine}
            selectedChanged={value =>
              this.setValue('IsUnderLine', value, ClassType.bool)
            }
          />
